...
package hislope.filters.pixelbender.fx.halftone.patterns
{
	...
	public class StripesPattern extends PBFilterBase
	{
		// CONSTANTS //////////////////////////////////////////////////////////////////////////

		private static const NAME:String = "Lines Pattern";
		...
		[Embed("../../../../../pbj/fx/halftone/patterns/RasterStripes.pbj", mimeType="application/octet-stream")]
		...
		public function StripesPattern(OVERRIDE:Object = null)
		{
			super(pbjFile);
		...
		override public function updateParams():void
		{
			...
			shader.data.dotSize.value = [lineWidth];
